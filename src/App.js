...
const TimetableApp = () => {
  ...
  const [selectedSemester, setSelectedSemester] = useState('VII'); // Default to VII
  ...
  // Auto-rotate sections and semesters
  useEffect(() => {
    if (!isAutoRotating) return;

    const rotationTimer = setInterval(() => {
        const semesters = ['III', 'V', 'VII']; // Added VII
        let sectionsForSem = [];
        if (selectedSemester === 'III') sectionsForSem = ['A', 'B', 'C', 'D', 'E'];
        else if (selectedSemester === 'V') sectionsForSem = ['A', 'B', 'C', 'D'];
        else if (selectedSemester === 'VII') sectionsForSem = ['A', 'B', 'C', 'D']; // Added VII sections
  ...
  }, [isAutoRotating, selectedSection, selectedSemester]);
  ...
  const thirdSemFaculty = { 'DMGT': { A: 'Dr. V.S.Naresh', B: 'Mr. N.V.Murali Krishna Raja', C: 'Mr. N.V.Murali Krishna Raja', D: 'Dr. V.S.Naresh', E: 'Mr. N.V.Murali Krishna Raja'}, 'MEFA': { A: 'Mrs. V. Sandhya', B: 'Mr. D. Satyanarayana', C: 'Mrs. V. Sandhya', D: 'Dr. K. Rambabu', E: 'Dr. K. Rambabu'}, 'DLCO': { A: 'Mrs. Y Sunitha', B: 'Mrs. Y Sunitha', C: 'Mrs. Y Sunitha', D: 'Mrs.M Vineela', E: 'Mrs.M Vineela'}, 'ADSAA': { A: 'Mrs. B.Sri Ramya', B: 'Mrs. B.Sri Ramya', C: 'Mr. K. Lakshmi Narayana', D: 'Mr. K. Lakshmi Narayana', E: 'Mrs. A. Naga Jyothi'}, 'OOPTJ': { A: 'Dr. K. Shirin Bhanu', B: 'Dr. K. Shirin Bhanu', C: 'Mr. G. Nataraj', D: 'Mr. G. Nataraj', E: 'Mr.L Atri Datta Ravi Tez'}, 'ADSAA Lab': { A: 'Mrs. B.Sri Ramya', B: 'Mrs. B.Sri Ramya', C: 'Mr. K. Lakshmi Narayana', D: 'Mr. K. Lakshmi Narayana', E: 'Mrs. A. Naga Jyothi'}, 'OOPTJ Lab': { A: 'Dr. K. Shirin Bhanu', B: 'Dr. K. Shirin Bhanu', C: 'Mr. G. Nataraj', D: 'Mr. G. Nataraj', E: 'Mr.L Atri Datta Ravi Tez'}, 'PP Lab': { A: 'Mr. K. Lakshmi Narayana', B: 'Mr. E Hanuman Sai Guptha', C: 'Mr. E Hanuman Sai Guptha', D: 'Mr.Md. Sadik', E: 'Mr.Md. Sadik'}, 'DTI': { A: 'MV V Gopala Krishna Murthy', B: 'MV V Gopala Krishna Murthy', C: 'Mr. B Bhasker Murali Krishna', D: 'Mr. B Bhasker Murali Krishna', E: 'Mr. P. Rama Mohan Rao'}, 'PCS-I': { A: 'Mrs. Ch Tanuja / Mr. G Srinivasa Rao', B: 'Mr. M Venkata Ramana/Ms. A Kiranmayee', C: 'Mr. M Venkata Ramana/Dr. B Ananda Rao', D: 'Mrs. Ch Tanuja / Dr. K Venkata Rao', E: 'Ms. A Kiranmayee / Dr. B Ananda Rao'} };
  ...
  const seventhSemFaculty = { 'DL': { A: 'Mr.P. Naga Bhushanam', B: 'Mr.P. Naga Bhushanam', C: 'Mr.P. Naga Bhushanam', D: 'Mr. E. Hanuman Sai Gupta' }, 'CC': { A: 'Mr. P. Rama Mohan Rao', B: 'Mr. P. Rama Mohan Rao', C: 'Mr. K. Praveen Kumar', D: 'Mr. K. Praveen Kumar' }, 'SPM': { A: 'Mr. B Bhasker Murali Krishna', B: 'Mr. B Bhasker Murali Krishna', C: 'Mr. B Bhasker Murali Krishna', D: 'Mr. Sd. Arief' }, 'MS': { A: 'Ms. P. Bala Jyothi', B: 'Ms. P. Bala Jyothi', C: 'Ms. P. Bala Jyothi', D: 'Mr. P. Bharath Kumar' }, 'DEVOPS': { A: 'Mrs. M.N.V. Surekha', B: 'Mrs. M.N.V. Surekha', C: 'Mrs. M.N.V. Surekha', D: 'Mrs. M.N.V. Surekha' }, 'FST': { A: 'Mr. Anil Kumar Reddy Tetali / Mr. K Phanindra Brahmaji', B: 'Mr. Anil Kumar Reddy Tetali/ Mr. K Phanindra Brahmaji', C: 'Mr. Anil Kumar Reddy Tetali / Mr. K Phanindra Brahmaji', D: 'Mr. Anil Kumar Reddy Tetali / Mr. K Phanindra Brahmaji' }, 'MAIN PROJECT': { A: 'Mrs. M.N.V. Surekha', B: 'Mr. Anil Kumar Reddy Tetali', C: 'Mr. K. Praveen Kumar', D: 'Mr.P. Naga Bhushanam / Ms.Ch Naga Padma Latha' }};

  const getCurrentData = () => {
    switch (selectedSemester) {
        case 'III':
            return { data: thirdSemData, subjects: thirdSemSubjects, faculty: thirdSemFaculty, sections: ['A', 'B', 'C', 'D', 'E'] };
        case 'V':
            return { data: fifthSemData, subjects: fifthSemSubjects, faculty: fifthSemFaculty, sections: ['A', 'B', 'C', 'D'] };
        case 'VII':
            return { data: seventhSemData, subjects: seventhSemSubjects, faculty: seventhSemFaculty, sections: ['A', 'B', 'C', 'D'] };
        default:
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            ...
            <div>
              ...
              <p style={{
                ...
                {selectedSemester} Semester - Computer Science & Engineering
              </p>
            </div>
          </div>
          <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                fontWeight: '500',
                transition: 'all 0.2s',
                backgroundColor: isAutoRotating ? '#16a34a' : '#9ca3af',
                color: 'white'
              }}
            >
              {isAutoRotating ? '⏸️ Auto-Rotation ON' : '▶️ Auto-Rotation OFF'}
            </button>
              ...
              {currentDay !== 'Sunday' && todaysSchedule.length > 0 ? (
                <tr style={{ borderTop: '1px solid #e2e8f0', backgroundColor: '#eff6ff' }}>
                  ...
                  {timePeriods.map((period, periodIndex) => {
                    ...
                    // MODIFIED: Added MCCP-I to lab check
                    ...
                    // MODIFIED: Added MCCP-I to lab styling
                    if (subject) {
